...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        # Account withdrawal at the top right of the screen.
        self.score_rect = self.score_image.get_rect()
        self.score_rect.right = self.screen_rect.right - 20
        self.score_rect.top = 20

    def show_score(self):
        """Displays the score, record and number ships on the screen."""
    ...
    def prep_level(self):
        """Converts a level to a graphical representation."""
